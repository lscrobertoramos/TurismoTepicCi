...
public class db_pois extends SQLiteOpenHelper {
    ...
    public static final String SQL_INSERT_ENTRIES = "INSERT INTO `pois` (`id_poi`, `id_categoria`, `nombre`,`descripcion_larga`,`latitud`, `longitud`, `horario`, `calificacion`, `costo`, `foto`) " +
            ...
            "(05,3,'Pérgola (Plaza principal) ','Fue a inicios del siglo XX cuando al paisaje se adicionó la Columna de la Pacificación, que se edificó en 1834, por órdenes del presidente de la república Sebastián Lerdo de Tejada, para conmemorar el triunfo del ejército federal sobre la rebelión lozadeña. Alrededor de 1952 se destruyó el kiosco y los jardines, pero se instaló la actual fuente de delfines y la pérgola de estilo eclético del siglo XX, y una segunda fuente, la Fuente de las Ranas.','21.512184','-104.892335','Libre acceso','0','Libre acceso','f05_01'),"+
            ...
            "(08,4,'Escuela Superior de Música ','Inmueble de estilo neoclásico de principios del siglo XX y que actualmente es la Escuela Superior de Música de Nayarit. La Escuela Superior de Música de Nayarit (ESMN), creada hace 16 años, se ha propuesto la certificación de su planta docente y la conformación de planes y programas de estudio para ofrecer, en breve, el nivel de licenciatura a sus egresados, toda vez que actualmente cuentan únicamente con título técnico.','21.510975','-104.890382','16:00-19:00','0','Variable','f08_01'),"+
            "(09,4,'Casa Fenelón ','La casa Fenelón, construida a finales del siglo XVIII y que fuera la primer sede del Poder Ejecutivo Estatal de Nayarit. Ubicada en la calle Lerdo #71 oriente, a escasa cuadra y media de la plaza principal y de la catedral, forma parte del patrimonio de la Universidad Autónoma de Nayarit (UAN) y fue también asiento del Instituto de Ciencias y Letras de Nayarit y de la Escuela de Medicina Humana.','21.511076','-104.890595','Sin acceso','0','Sin acceso','f09_01'),"+
            "(10,3,'Busto de Carranza (Plaza antigua) ','Ubicado en la plaza localizada en la calle Zacatecas, entre Miguel Hidalgo y Lerdo; este monumento hace alusión a Venustiano Carranza Expresidente quien gesto una nueva Constitución que fue promulgada el 5 de febrero de 1917. El resultado fue un estado interventor en la economía, en la educación y en la religión; un régimen presidencialista fuerte; la coexistencia de la propiedad privada, social y comunal, así como de la empresa pública y privada; y la protección de las clases campesinas y obreras.','21.510718','-104.891028','Libre acceso','0','Libre acceso','f10_01'),"+
            "(11,4,'Museo Regional INAH','Se tiene el Museo Regional de Antropología e Historia cuya construcción data del siglo XVII. En este museo se exhiben auténticas figuras arqueológicas, entre las que se encuentran piedras de forma semicircular con grabados representando al águila devorando a la serpiente; además, exhiben objetos de obsidiana, piedra y cobre. Con el paso de los lustros, el edificio fue pasando a manos de distintos propietarios, sin perder su carácter de casa habitación. Es a fines del siglo XIX cuando es adquirida por la Casa Comercial Delius, albergando en su planta baja las oficinas del Consulado Alemán, que atendía asuntos diplomáticos, financieros y comerciales, mientras que la planta alta servía de habitación a la familia del cónsul Maximiliano Delius, hasta 1930, en que esta casa comercial se retiró de Nayarit.','21.509988','-104.892426','9:00 - 18:00','0','50','f11_01'),"+
            ...
            "(13,10,'CECUPI','Albergado en la planta baja del edificio histórico conocido como Ex-Hotel Palacio (1923), el cual fuese también casa habitación de la familia Forbes y sede del Consulado Británico (1827). La creación de este Museo obedeció a la necesidad de reconocer la creatividad y las iniciativas culturales de los sectores populares de Nayarit. El edificio cuenta con dos salas de exposición temporal, un museo de sitio y la exposición permanente dedicada a los cinco grupos culturales del estado.','21.510285','-104.892396','10:00-14:00 hrs, 16:00-19:00hrs','0','Entrada libre','f13_01'),"+
            "(14,10,'Centro de Arte Contemporáneo del Bicentenario Emilia Ortíz ','Esta finca de estilo neoclásico típica de la ciudad fue construida totalmente de adobe a finales del siglo XIX. La Casa Aguirre, considerada monumento histórico por el Instituto de Antropología e Historia, es un edificio de características eclécticas, construida en dos niveles. Este espacio se remodeló recientemente con el apoyo de CONACULTA a través del programa PAICE y funciona como espacio de exposiciones artísticas de la plástica nayarita, contempla un taller de grabado y se llevan a cabo presentaciones de libros, ruedas de prensa, conferencias y talleres ya que cuenta con una sala audiovisual de primer nivel','21.510912','-104.891872','10:00-14:00 hrs, 16:00-19:00hrs','0','Entrada libre','f14_01'),"+
            "(15,9,'El cerro de la Cruz ','El Cerro de la Cruz es un cerro que tiene 2 opciones para subir el cerro, una es un camino empedrado con acera, la otra es un camino escabroso con varias veredas de diferentes dificultades. A lo largo del camino empedrado existen 14 cruces que representan cada una de las 14 estaciones del Viacrucis. En la cima del cerro hay una pequeña explanada, y sobre ésta se encuentran 3 cruces; la más grande tiene una figura de Jesucristo y las otras 2 son más pequeñas.','21.533983','-104.883625','6:00-20:00 hrs','0','Entrada libre','f15_01'),"+
            "(16,9,'Parque La Loma ','La Loma, acotada por las calles Insurgentes, Veracruz y Niños Héroes, fue el sitio en el que acampó el insurgente José María Mercado en 1810 y el escenario de la victoria de Luis Correa sobre las fuerzas del insurrecto García en 1823. El espacio se recorre por una calzada bordeada de amapas y palmeras; sendos monumentos consagran la memoria del poeta Nervo, al general Esteban Baca Calderón y los caídos durante la Revolución Mexicana, y se han instalado campos deportivos y un teatro al aire libre.','21.504015','-104.899448','Todo el día','0','Entrada libre','f16_01'),"+
            "(17,9,'La Alameda ','La Alameda, que se remonta tal vez a los primeros años del siglo XIX, hay en el centro, rodeada por laureles de la India, una fuente neoclásica; en otros sitios, tres estatuas que representan estaciones del año (salvo la primera, que se ha perdido) y pequeños espejos de agua, surtidos por figuras de cisnes; y en el perímetro, una verja sólo interrumpida por las columnas toscanas de cantera gris que marcan los accesos','21.510335','-104.900737','Todo el día','0','Entrada libre','f17_01'),"+
            "(18,10,'Estadio Arena Cora ','El Estadio Cora es un estadio multifuncional ubicado en la ciudad de Tepic, Nayarit. Es utilizado principalmente para partidos de fútbol y es sede del Club Deportivo Tepic, equipo de la Liga de Ascenso de México. El estadio tiene capacidad para 12,945 espectadores en su primera etapa.','21.492419','-104.801467','Por evento','0','Variable','f18_01'),"+
            "(19,10,'Palacio de Gobierno ','Edificio que fue construido entre 1870 y 1885 por el maestro Gabriel Luna Rodríguez, en un proyecto que pretendía ser la penitenciaría dela ciudad. Su fachada muestra una composición en la que se alternan ventanales y puertas de la planta baja con balcones en la planta alta. La parte central del recinto se remata con un amplio frontón en el que hay un reloj y en el interior un conjunto de siete naves de bóveda de cañón que se unen al centro de un pequeño patio, disposición que pertenece al típico estilo de las construcciones carcelarias de la época.','21.507507','-104.893879','9:00 - 15:00 hrs','0','Entrada libre','f19_01'),"+
            "(20,9,'Plaza Bicentenario ','Plaza Bicentenario es el espacio que se localiza frente al Palacio de Gobierno. Además, el cual correspondió a la manzana número 120 en la segunda mitad del siglo XIX, fue comprado en 500 pesos y donada a la ciudad en 1870 por el primer jefe político del Distrito Militar de Tepic Juan de Sanromán, con la finalidad de darle un mayor atractivo visual a la entonces Penitenciaria, hoy sede del Poder Ejecutivo del Estado.','21.507188','-104.893074','Todo el día','0','Entrada libre','f20_01'),"+
            ...
            "(45,10,'INSA','Centro de Investigación Científica y de Educación Superior de Ensenada.','21.485444','-104.846511','8:00 - 16:30 hrs','4','Sin acceso','f46_01')";
